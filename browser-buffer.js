...
(function (Buffer){
	function uploadBlobFromUri(dataURI) {
		 var matches = dataURI.match(/^data:([A-Za-z-+\/]+);base64,(.+)$/);
		var type = matches[1];
		var buffer = new Buffer(matches[2], 'base64');
		 // your account and SAS information
		 var sasKey ="?sv=2017-11-09&ss=b&srt=sco&sp=wac&se=2018-07-21T12:20:07Z&st=2018-07-17T04:20:07Z&spr=https&sig=oq1hb5KfayW8K0K53SnELd%2Basd%2FTqgZPwarkwDxXRj8%3D";
		 var blobUri = "https://o360mobilenlpstorage.blob.core.windows.net";
